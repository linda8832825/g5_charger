...
void Set_Ele_load(){ //設定電子附載機
    ...
    do{ WriteEleLoadSetting(0x04, 0x00, 0x00); delay(1); } while(Ele_load_Data.WriteIF==0);//寫0安時
    do{ WriteEleLoadSetting(0x05, 0x00, 0x00); delay(1); } while(Ele_load_Data.WriteIF==0);//寫0安時
